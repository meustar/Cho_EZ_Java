    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < 8; i++) {
            ...
            if (randomNumber == guess) {
                ...
                // 축하 메시지를 출력한 후 반복문을 탈출
                System.out.println("축하합니다. 정답입니다. " + i + "번 만에 성공하셨습니다.");
                break;
                ...
                // 크다는 메시지를 출력
                System.out.println("제가 생각한 숫자보다 더 큽니다.");
            }
